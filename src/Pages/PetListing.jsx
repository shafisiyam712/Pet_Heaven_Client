    ...
    return (
        <div className=''>
            <div className="text-center my-14">
                <h1 className="font-extrabold text-[#1E2A47] dark:text-white text-3xl mb-3">Explore Our Vast Collections of Pets</h1>
                <h2 className='mb-3'>There is a huge collection of pets added by our users and admins. <br />
                You can search them by name and select category.
                </h2>
